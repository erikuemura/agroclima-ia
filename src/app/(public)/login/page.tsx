  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-stone-100 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <Card className="p-6">
          <div className="flex rounded-lg bg-stone-100 p-0.5 mb-5">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full border border-stone-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 pr-10"
                />
          ...
          <button onClick={handleGoogle}
            className="w-full border border-stone-200 rounded-lg py-2.5 text-sm text-stone-700 hover:bg-stone-50 transition-colors flex items-center justify-center gap-2">
        ...
        <p className="text-center text-xs text-stone-400 mt-4">
          Ao entrar você concorda com os termos de uso · Para produtores rurais
        </p>
      </div>
    </div>
  )
