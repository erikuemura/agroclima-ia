...
export default function PrecosPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-stone-900">
      {/* NAV */}
      <nav className="flex items-center justify-between px-4 sm:px-8 py-4 border-b border-stone-100">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          <Link href="/" className="hidden sm:block text-sm text-stone-500 hover:text-stone-800">Voltar ao site</Link>
          <Link href="/login" className="text-sm bg-green-800 text-white rounded-lg px-3 sm:px-4 py-2 hover:bg-green-900 transition-colors">
            Criar conta grátis
          </Link>
        </div>
      </nav>
      ...
      <section className="py-10 sm:py-16 px-4 sm:px-8 text-center">
        <h1 className="text-2xl sm:text-4xl font-medium text-stone-900 mb-3">Planos simples e transparentes</h1>
        <p className="text-stone-500 mb-8 max-w-md mx-auto text-sm sm:text-base">Comece grátis e escale conforme sua fazenda cresce. Sem surpresas na fatura.</p>
        ...
        {/* ENTERPRISE */}
        <div className="max-w-4xl mx-auto mt-5 border border-stone-200 rounded-2xl p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:justify-between bg-stone-50">
          ...
          <Link href="mailto:contato@campoclima.com.br" className="text-sm border border-stone-300 rounded-lg px-4 py-2 text-stone-700 hover:bg-white transition-colors flex items-center gap-1.5 self-start sm:self-auto">
      ...
      {/* COMPARATIVO */}
      <section className="py-12 sm:py-16 px-4 sm:px-8 bg-stone-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-xl sm:text-2xl font-medium text-stone-900 text-center mb-8">Comparativo completo</h2>
      ...
      {/* CTA */}
      <section className="bg-green-950 py-12 sm:py-16 px-4 sm:px-8 text-center">
      ...
      <footer className="border-t border-stone-100 px-4 sm:px-8 py-5 flex flex-col sm:flex-row items-center gap-3 sm:justify-between">
